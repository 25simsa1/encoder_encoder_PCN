...
NEXT (user-chosen direction): design a generative objective that rewards high-frequency AMPLITUDE and breaks the mean-seeking, strictly within bidirectional PC (a frequency/amplitude-weighted term in the PC energy, or a noise/sampling mechanism). Entering the design cycle for it.
